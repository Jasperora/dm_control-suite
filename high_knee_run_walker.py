...
"""High Knee Run Planar Walker Domain."""
...
def vel_1(
    ...
    task = HighKneeRunPlanarWalker(x_vel_limit=1, random=random)
...
def vel_2(
    ...
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = HighKneeRunPlanarWalker(x_vel_limit=2, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_3(
    ...
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = HighKneeRunPlanarWalker(x_vel_limit=3, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_4(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = HighKneeRunPlanarWalker(x_vel_limit=4, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_5(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = HighKneeRunPlanarWalker(x_vel_limit=5, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_6(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = HighKneeRunPlanarWalker(x_vel_limit=6, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
class HighKneeRunPlanarWalker(base.Task):
    ...
    def __init__(self, x_vel_limit, random=None):
        ...
        super(HighKneeRunPlanarWalker, self).__init__(random=random)
    ...
    def initialize_episode(self, physics):
        ...
        super(HighKneeRunPlanarWalker, self).initialize_episode(physics)
