...
def vel_1(
    ...
    task = BackwardPlanarWalker(x_vel_limit=1, random=random)
...
def vel_2(
    ...
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = BackwardPlanarWalker(x_vel_limit=2, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_3(
    ...
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = BackwardPlanarWalker(x_vel_limit=3, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_4(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = BackwardPlanarWalker(x_vel_limit=4, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_5(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = BackwardPlanarWalker(x_vel_limit=5, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_6(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = BackwardPlanarWalker(x_vel_limit=6, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_7(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = BackwardPlanarWalker(x_vel_limit=7, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_8(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = BackwardPlanarWalker(x_vel_limit=8, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_9(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = BackwardPlanarWalker(x_vel_limit=9, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_10(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = BackwardPlanarWalker(x_vel_limit=10, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
class BackwardPlanarWalker(base.Task):
    ...
    def __init__(self, x_vel_limit, random=None):
        ...
        super(BackwardPlanarWalker, self).__init__(random=random)
    ...
    def initialize_episode(self, physics):
        ...
        super(BackwardPlanarWalker, self).initialize_episode(physics)
    ...
    def get_reward(self, physics):
        ...
        delta_h = physics.named.data.geom_xpos["torso","z"] - max(physics.named.data.xpos["right_foot","z"], physics.named.data.xpos["left_foot","z"])
        nz = np.cos(angle)
