...
def vel_1(
    ...
    task = CrawlPlanarWalker(x_vel_limit=1, random=random)
...
def vel_2(
    ...
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = CrawlPlanarWalker(x_vel_limit=2, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_3(
    ...
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = CrawlPlanarWalker(x_vel_limit=3, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_4(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = CrawlPlanarWalker(x_vel_limit=4, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_5(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = CrawlPlanarWalker(x_vel_limit=5, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_6(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = CrawlPlanarWalker(x_vel_limit=6, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_7(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = CrawlPlanarWalker(x_vel_limit=7, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_8(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = CrawlPlanarWalker(x_vel_limit=8, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_9(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = CrawlPlanarWalker(x_vel_limit=9, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
def vel_10(
    ...
    """Returns the Run task."""
    physics = Physics.from_xml_string(*get_model_and_assets())
    task = CrawlPlanarWalker(x_vel_limit=10, random=random)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(
        physics,
        task,
...
class CrawlPlanarWalker(base.Task):
    ...
    def __init__(self, x_vel_limit, random=None):
        ...
        super(CrawlPlanarWalker, self).__init__(random=random)
    ...
    def initialize_episode(self, physics):
        ...
        super(CrawlPlanarWalker, self).initialize_episode(physics)
    ...
    def get_reward(self, physics):
        ...
        reward = x_vel_reward + angle_reward + height_penalty + \
                ctrl_penalty + alive_reward + foot_penalty + crawl_reward
